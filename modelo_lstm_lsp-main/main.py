...
class VideoRecorder(QMainWindow):
    def __init__(self):
        ...
        self.capture.set(cv2.CAP_PROP_FPS, 15)  # Limit camera FPS
        ...
        self.timer.start(50)  # Reduced to 20 FPS for better performance
    ...
    def init_lsp(self):
        ...
        # Add prediction throttle counter
    ...
    def update_frame(self):
        ...
        scaled_qImg = qImg.scaled(self.lbl_video.size(), Qt.KeepAspectRatio, Qt.FastTransformation)
